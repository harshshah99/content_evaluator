...
prompt = ChatPromptTemplate.from_messages(
    [("system", "You are an AI assistant with an expertise in marketing content like blogs, outreach emails and more. Follow the instructions to provide insights and details regarding the content input by the user"), 
